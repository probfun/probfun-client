<template>
<<<<<<< Updated upstream:src/components/star/StarPanel.vue
=======
  <div class="w-full h-screen bg-gray-50 overflow-auto">
    ...
    <div class="flex h-[calc(100vh-150px)] p-5">
      <ChoiceQuestionViewer ref="questionViewer" :question-id="currentQuestionId" :current-section="currentSection" :chapter-id="chapterId"
...
>>>>>>> Stashed changes:src/components/do-question/DoQuestionPanel.vue
</template>
...
const chapterId = ref(1); // 添加chapterId定义
