...
// 章节1题目数据
export const chapter1Section1Questions: Question[] = [
  // {
  //   id: 1,
...
// 章节2题目数据
export const chapter1Section2Questions: Question[] = [
  {
    id: 1,
    category: '1.2 事件的概率',
...
export const chapter2Section1Questions: Question[] = [
  {
    id: 1,
...
export const questionSectionMap: { [key: string]: Question[] } = {
  'chapter1/section1': chapter1Section1Questions,
  'chapter1/section2': chapter1Section2Questions,
  'chapter2/section1': chapter2Section1Questions
};