...
export const initialNodes = [
  ...
  createNode({ label: 'Polya(n,p,β)' }, { x: -350, y:100 },),
  createNode({ label: 'Gamma-normal(μ，α，β)' }, { x: -350, y:100 },),
  createNode({ label: 'Discrete Weibull(p,β)\nV' }, { x: -350, y:100 },),
  createNode({ label: 'Standard normal' }, { x: -350, y:100 },),
  createNode({ label: 'Log normal(α，β)\nP' }, { x: -350, y:100 },),
  createNode({ label: 'Noncentral beta(β，γ，δ)' }, { x: -350, y:100 },),
  createNode({ label: 'Arctangent(λ,Φ)\nS,V' }, { x: -350, y:100 },),
  createNode({ label: 'Noncentral chi-square(n,δ)\nC' }, { x: -350, y:100 },),
  createNode({ label: 'Log gamma(α,β)' }, { x: -350, y:100 },),
  createNode({ label: 'Generalized gamma(α，β,γ)' }, { x: -350, y:100 },),
  createNode({ label: 'Hyperbolic-secant\nV' }, { x: -350, y:100 },),
  createNode({ label: 'Inverse Gaussian(λ,μ)\nLμi/(μi²ai)' }, { x: -350, y:100 },),
  createNode({ label: 'Chi(n)' }, { x: -350, y:100 },),
  createNode({ label: 'Inverted gamma(α,β)' }, { x: -350, y:100 },),
  createNode({ label: 'Gamma(α,β)\nCα,S' }, { x: -350, y:100 },),
  createNode({ label: 'Beta(β,γ)' }, { x: -350, y:100 },),
  createNode({ label: 'Cauchy(a,α)\nC,I,S,V' }, { x: -350, y:100 },),
  createNode({ label: 'Standard Waid(λ)\nS' }, { x: -350, y:100 },),
  createNode({ label: 'Chi-square(n)\nC' }, { x: -350, y:100 },),
  createNode({ label: 'Inverted beta(β,γ)' }, { x: -350, y:100 },),
  createNode({ label: 'Arcsin\nV' }, { x: -350, y:100 },),
  createNode({ label: 'Standard Cauchy\nI,S,V' }, { x: -350, y:100 },),
  createNode({ label: 't(n)' }, { x: -350, y:100 },),
