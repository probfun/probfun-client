...
<template>
  <div class="grid grid-cols-2 gap-4">
    <div id="plotly-chart2" ref="plotlyChart2" class="w-full h-64" />
    <div id="plotly-chart1" ref="plotlyChart1" class="w-full h-64" />
    <div id="plotly-chart3" ref="plotlyChart3" class="w-full h-64" />
    <div id="plotly-chart4" ref="plotlyChart4" class="w-full h-64" />
  </div>
</template>
