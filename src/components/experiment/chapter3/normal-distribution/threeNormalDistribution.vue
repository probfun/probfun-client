...
const oneFormula = computed(() => {
    ...
    f(x, y) = 
    \\frac{1}{2\\piσ_1σ_2\\sqrt{1-ρ^2}}  e^{\\frac{-1}{2(1-ρ^2)}[\\frac{(x-μ_1)^2}{σ_1^2}-2ρ\\frac{(x-μ_1)(y-μ_2)}{σ_1σ_2}+\\frac{(y-μ_2)^2}{σ_2^2}]} 
   \\\\
    \\phantom{f(x, y)}
    \\\\
    \\text{则边缘分布概率密度函数为:\\;}\ 
...
$$
 f(x, y) = 
    \\frac{1}{2\\piσ_1σ_2\\sqrt{1-ρ^2}}  e^{\\frac{-1}{2(1-ρ^2)}[\\frac{(x-μ_1)^2}{σ_1^2}-2ρ\\frac{(x-μ_1)(y-μ_2)}{σ_1·σ_2}+\\frac{(y-μ_2)^2}{σ_2^2}]} 
$$
其中：
