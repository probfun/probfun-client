      ...
      <div class="container mx-auto p-4">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
          <div class="flex justify-between items-center mb-4">
            <h3 class="text-lg font-semibold text-gray-800">流量特征趋势</h3>
          ...
          <div class="h-80 relative">
            <canvas ref="trafficCanvas" v-show="chartsLoaded"></canvas>
            <div v-if="!chartsLoaded || chartError" class="h-full flex items-center justify-center text-gray-500">
              <div class="text-center">
                <div v-if="!chartError" class="animate-spin w-8 h-8 border-4 border-blue-500 border-t-transparent rounded-full mx-auto mb-2"></div>
                ...
                <button v-if="chartError" @click="retryChartLoad" class="mt-2 px-3 py-1 bg-blue-500 text-white rounded text-sm hover:bg-blue-600">
                  重试
                </button>
              </div>
            </div>
        ...
        <!-- 流量速率自相关图 -->
        <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
          <h3 class="text-lg font-semibold text-gray-800 mb-4">流量速率自相关</h3>
          <div class="h-80 relative">
            <canvas ref="autocorrelationCanvas" v-show="chartsLoaded"></canvas>
            <div v-if="!chartsLoaded || chartError" class="h-full flex items-center justify-center text-gray-500">
              <div class="text-center">
                <div v-if="!chartError" class="animate-spin w-8 h-8 border-4 border-blue-500 border-t-transparent rounded-full mx-auto mb-2"></div>
                <div v-else class="w-8 h-8 bg-red-100 rounded-full mx-auto mb-2 flex items-center justify-center">
        ...
        <!-- 特征相关系数矩阵 -->
        <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
          <h3 class="text-lg font-semibold text-gray-800 mb-4">特征相关系数矩阵</h3>
          <div class="overflow-x-auto">
            <div class="inline-block min-w-full">
              <div class="grid grid-cols-6 gap-1 text-sm">
                <!-- 矩阵标题行 -->
                <div class="bg-gray-100 p-3 text-center font-semibold"></div>
    ...
    <template #parameter>
      <div class="container mx-auto p-4">
        <div class="bg-white rounded-lg shadow p-6">
          <h3 class="text-lg font-semibold text-gray-800 mb-4">场景选择</h3>

          <div class="grid grid-cols-2 gap-4 mb-6">
            <button @click="setScenario('normal')"
          ...
          <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <h4 class="font-semibold text-blue-800 mb-2">当前场景说明</h4>
            <p class="text-blue-700 text-sm">{{ scenarioDescription }}</p>
          </div>
        </div>
      </div>
    </template>
...
// 方法
const scenarioButtonClass = (scenario) => {
  return currentScenario.value === scenario
      ? 'border-blue-500 bg-blue-50 text-blue-700'
      : 'border-gray-200 bg-white text-gray-700 hover:border-gray-300';
};

const getMatrixCellColor = (value, isDiagonal) => {
  if (isDiagonal) {
...
const generateTrafficData = (scenario) => {
  const data = {
    srcIP: [],
    destIP: [],
    trafficRate: []
...
const generateAutocorrelationData = (scenario) => {
  const scenarios = {
...
const updateCharts = () => {
  if (!chartsLoaded.value || chartError.value) return;
