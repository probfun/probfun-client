...
import BoxSelector from '@/components/mode/BoxSelector.vue'
...
<template>
  <div class="h-full w-full flex">
    <div 
      class="w-[61.8%] lg:flex items-center justify-center border-r hidden select-none transition-colors duration-800"
