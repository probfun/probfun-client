  ...
  const nodeData = ref<NodeOptions[]>([
    {
      ...
      pmf: '\n$$\nf(x) = \\frac{1}{x^\\alpha \\sum\\limits_{i=1}^n \\left(\\frac{1}{i}\\right)^\\alpha}, \\quad x = 1, 2, \\ldots, n\n$$\n',
      imgPath: '/distribution/zipf.png',
    },
    {
      ...
      imgPath: '/distribution/discrete_uniform.png',
    },
    {
      label: 'Rectangular(n)\nV',
      position: { x: 600, y: 0 },
      chineseTranslation: '矩形分布(n)\nV',
      pmf: '\n$$\nf(x) = \\frac{1}{n + 1}, \\quad x = 0, 1, 2, \\ldots, n\n$$\n',
      imgPath: '/distribution/rectangular.png',
    },
    {
      label: 'Beta-binomial\n(a,b,n)',
      position: { x: 900, y: 0 },
      chineseTranslation: '贝塔二项分布\n(a, b, n)',
      pmf: '\n$$\nf(x) = \\frac{\\Gamma(x + a)\\, \\Gamma(n - x + b)\\, \\Gamma(a + b)\\, \\Gamma(n + 2)}{(n + 1)\\, \\Gamma(a + b + n)\\, \\Gamma(a)\\, \\Gamma(b)\\, \\Gamma(x + 1)\\, \\Gamma(n - x + 1)}, \\quad x = 0, 1, \\ldots, n\n$$\n',
      imgPath: '/distribution/beta_binomial.png',
    },
    {
      label: 'Negative hypergeometric\n(n1,n2,n3)',
      position: { x: 1250, y: 0 },
      chineseTranslation: '负超几何分布\n(n1, n2, n3)',
      pmf: '\n$$\nf(x) = \\frac{\\binom{n_1 + x - 1}{x} \\binom{n_3 - n_1 + n_2 - x - 1}{n_2 - x}}{\\binom{n_3 + n_2 - 1}{n_2}}, \\quad x = 0, 1, \\ldots, n_2\n$$\n',
      imgPath: '/distribution/negative_hypergeometric.png',
    },
    {
      label: 'Zeta(α)',
      position: { x: 0, y: 100 },
      chineseTranslation: 'Zeta分布(α)',
      pmf: '\n$$\nf(x) = \\frac{1}{x^\\alpha \\sum\\limits_{i=1}^{\\infty} \\left(\\frac{1}{i}\\right)^\\alpha}, \\quad x = 0, 1, 2, \\ldots\n$$\n',
      imgPath: '/distribution/zeta.png',
    },
    {
      label: 'Logarithm(c)',
      position: { x: 150, y: 200 },
      chineseTranslation: '对数分布(c)',
      pmf: '\n$$\nf(x) = -\\frac{(1 - c)^x}{x \\ln c}, \\quad x = 1, 2, \\ldots\n$$\n',
      imgPath: '/distribution/logarithm.png',
    },
    {
      label: 'Power series(c,A(c))',
      position: { x: 300, y: 100 },
      chineseTranslation: '幂级数分布(c, A(c))',
      pmf: '\n$$\nf(x) = \\frac{a_x c^x}{A(c)}, \\quad x = 0, 1, 2, \\ldots\n$$\n',
      imgPath: '/distribution/power_series.png',
    },
    {
      label: 'Poisson(μ)\nC',
      position: { x: 450, y: 200 },
      chineseTranslation: '泊松分布(μ)\nC',
      pmf: '\n$$\nf(x) = \\frac{\\mu^x e^{-\\mu}}{x!}, \\quad x = 0, 1, 2, \\ldots\n$$\n',
      ...
      imgPath: '/distribution/poisson.png',
    },
    {
      label: 'Hypergeometric\n(n1,n2,n3)',
      position: { x: 1300, y: 120 },
      chineseTranslation: '超几何分布\n(n1, n2, n3)',
      pmf: '\n$$\nf(x) = \\frac{\\binom{n_1}{x} \\binom{n_3 - n_1}{n_2 - x}}{\\binom{n_3}{n_2}}, \\quad x = \\max\\{0, n_1 + n_2 - n_3\\}, \\ldots, \\min\\{n_1, n_2\\}\n$$\n',
      ...
      imgPath: '/distribution/hypergeometric.png',
    },
    {
      label: 'Beta-Pascal\n(n,a,b)',
      position: { x: 250, y: 500 },
      chineseTranslation: '贝塔-帕斯卡分布\n(n, a, b)',
      pmf: '\n$$\nf(x) = \\frac{\\binom{n - 1 + x}{x} B(n + a, b + x)}{B(a, b)}, \\quad x = 0, 1, \\ldots\n$$\n',
      imgPath: '/distribution/beta_pascal.png',
    },
    {
      ...
      imgPath: '/distribution/gamma_poisson.png',
    },
    {
      label: 'Binomial(n,p)',
      ...
      imgPath: '/distribution/binomial.png',
    },
    {
      label: 'Bernoulli(p)\nM,P,X',
      ...
      imgPath: '/distribution/bernoulli.png',
    },
    {
      label: 'Geometric(p)\nF,M,V',
      ...
      imgPath: '/distribution/geometric.png',
    },
    {
      label: 'Pascal(n,p)\nCp',
      position: { x: 0, y: 400 },
      chineseTranslation: '帕斯卡分布(n, p)\nCp',
      pmf: '\n$$\nf(x) = \\binom{n - 1 + x}{x} p^n (1 - p)^x, \\quad x = 0, 1, 2, \\ldots\n$$\n',
      imgPath: '/distribution/pascal.png',
    },
    {
      label: 'Normal(μ,σ²)\nL',
      ...
      imgPath: '/distribution/normal.png',
    ...
    },
    {
      ...
      imgPath: '/distribution/polya.png',
      pmf: '\n$$\nf(x) = \\binom{n}{x} \\frac{\\prod_{j=0}^{x-1} (p + j\\beta) \\prod_{k=0}^{n - x - 1} (1 - p + k\\beta)}{\\prod_{i=0}^{n - 1} (1 + i\\beta)}, \\quad x = 0, 1, 2, \\ldots, n\n$$\n',
    },
    {
      label: 'Gamma-normal(μ，α，β)',
      position: { x: 1100, y: 700 },
      chineseTranslation: '伽马正态分布(μ, α, β)',
      imgPath: '/distribution/gamma_normal.png',
      pdf: '$$\nf(\\mu, \\tau) = \\sqrt{\\frac{\\lambda \\tau}{2\\pi}} \\cdot \\frac{\\beta^\\alpha}{\\Gamma(\\alpha)} \\cdot \\tau^{\\alpha - \\frac{1}{2}} \\cdot \\exp\\left(-\\beta \\tau - \\frac{1}{2} \\lambda \\tau (\\mu - \\mu_0)^2\\right), \\quad \\mu \\in \\mathbb{R},\\ \\tau > 0\n$$',
    },
    {
      label: 'Discrete Weibull(p,β)\nV',
      position: { x: -400, y: 400 },
      chineseTranslation: '离散韦布尔分布(p, β)\nV',
      imgPath: '/distribution/discrete_weibull.png',
      pmf: '$$\nf(x) = (1 - p)^{x^\\beta} - (1 - p)^{(x + 1)^\\beta}, \\quad x = 0, 1, 2, \\ldots\n$$',
    },
    {
      label: 'Standard normal',
      position: { x: 580, y: 450 },
      chineseTranslation: '标准正态分布',
      pdf: '$$\nf(x) = \\frac{e^{-x^2 / 2}}{\\sqrt{2\\pi}}, \\quad -\\infty < x < \\infty\n$$\n',
      expId: 'normal-distribution',
    ...
    },
    {
      ...
      imgPath: '/distribution/log_normal.png',
      pdf: '$$\nf(x) = \\frac{1}{x\\beta \\sqrt{2\\pi}} e^{-\\frac{1}{2} \\left( \\frac{\\ln(x/\\alpha)}{\\beta} \\right)^2}, \\quad x > 0\n$$',
    ...
    },
    {
      ...
      imgPath: '/distribution/noncentral_beta.png',
      pdf: '$$\nf(x) = \\sum_{i=0}^{\\infty} \\frac{\\Gamma(i + \\beta + \\gamma)}{\\Gamma(\\gamma)\\Gamma(i + \\beta)} \\left( \\frac{e^{-\\delta/2}}{i!} \\right) \\left( \\frac{\\delta}{2} \\right)^i x^{i + \\beta - 1} (1 - x)^{\\gamma - 1}, \\quad 0 < x < 1\n$$',
    },
    {
      label: 'Arctangent(λ,Φ)\nS,V',
      position: { x: 150, y: 600 },
      chineseTranslation: '反正切(λ, Φ)\nS, V',
      pdf: '$$\nf(x) = \\frac{\\lambda}{\\left( \\arctan(\\lambda \\Phi) + 1/2\\pi \\right) \\left(1 + \\lambda^2 (x - \\Phi)^2 \\right)}, \\quad x \\geq 0\n$$',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\frac{1}{2} e^{-(x + \\delta)/2} \\left( \\frac{x}{\\delta} \\right)^{(n/4 - 1/2)} I_{n/2 - 1}(\\sqrt{\\delta x})\n$$\n',
    ...
    },
    {
      ...
      pdf: '$$\nf(x) = \\frac{e^{\\beta x} e^{-e^{x}/\\alpha}}{\\alpha^\\beta \\Gamma(\\beta)}, \\quad -\\infty < x < \\infty\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\frac{\\beta}{\\Gamma(\\alpha / \\gamma)} x^{\\alpha - 1} e^{-(x / \\gamma)^\\beta}, \\quad x > 0\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\frac{1}{2} \\text{sech}\\left(\\frac{\\pi x}{2}\\right)\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\frac{\\Gamma(\\beta + \\gamma)}{\\Gamma(\\beta) \\Gamma(\\gamma)} x^{\\beta - 1} (1 - x)^{\\gamma - 1}, \\quad 0 < x < 1\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\frac{1}{\\pi \\alpha \\left[ 1 + \\left( \\frac{x - a}{\\alpha} \\right)^2 \\right]}\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\frac{\\beta^{k} x^{k-1} e^{-\\beta x}}{(k-1)!}, \\quad k = n, \\beta = \\alpha\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\frac{\\sqrt{\\frac{(n1 x)^{n1} n2^{n2}}{(n1 x + n2)^{n1 + n2}}}}{x B(n1/2, n2/2)}\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\alpha e^{-\\alpha x}, \\quad x \\ge 0\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x;\\alpha,\\beta) = \\frac{\\beta}{\\alpha}e^{\\frac{x}{\\alpha}} · \\frac{1}{(1 + e^{\\frac{x}{\\alpha}})^{\\beta+1}}, \\quad x \\in \\mathbb{R}\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x;\\delta,\\kappa) = \\delta e^{\\kappa x} · e^{-\\delta \\frac{e^{\\kappa x}-1}{\\kappa}}, \\quad x \\ge 0, \\quad \\delta,\\kappa \\gt 0\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x;\\lambda,\\kappa) = \\frac{\\kappa}{2\\lambda \\Gamma(\\frac{1}{\\kappa})} · e^{-|\\frac{x}{\\lambda}|^\\kappa}, \\quad x\\in \\mathbb{R}, \\quad \\alpha,\\beta \\gt 0\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x;n,\\delta,\\gamma) = \\frac{2e^{-\\frac{\\delta^2+\\gamma^2}{2}}}{\\sqrt{nπ}\\Gamma(\\frac{n}{2})}\\Sigma^\\infty_{k=0}\\Sigma^\\infty_{m=0}\\frac{(\\delta^{2k}\\gamma^{2m})}{k!m!2^{k+m}} · \\frac{|x|^{2m+1}(x^2+n)^{-(k+m+\\frac{n+1}{2})}}{\\Gamma(k+m+\\frac{n+1}{2})}, \\\\\\ x\\in \\mathbb{R}, \\quad \\delta,\\gamma \\in \\mathbb{R}, \\quad n \\gt 0\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\Sigma^k_{i=1}p_i\\lambda_i e^{-\\lambda_i x}, \\quad x\\ge 0, \\quad \\lambda_i\\ge 0, \\quad \\Sigma^k_{i=1}p_i = 1 \\quad(i = 1,2,\\ldots,k)\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(t) = \\frac{\\kappa}{\\theta}(\\frac{t}{\\theta})^{\\kappa-1}e^{-(\\frac{t}{\\theta})^\\kappa}, \\quad t\\ge 0, \\quad \\theta,\\kappa\\gt 0\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\frac{e^{\\frac{(-\\frac{|x-a|}{b})^{\\frac{2}{c}}}{2}}}{b(2^{\\frac{c}{2}+1})\\Gamma(\\frac{c}{2} + 1)}, \\quad x\\in \\mathbb{R}\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\beta\\gamma x^{\\beta-1}(1-x^\\beta)^{\\gamma-1}, \\quad 0 < x < 1.\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x;n1,n2,\\delta) = \\Sigma^\\infty_{k=0}\\frac{e^{-\\frac{\\delta}{2}}(\\frac{\\delta}{2})^k}{k!} · \\frac{\\Gamma(\\frac{n1+n2}{2}+k)}{\\Gamma(\\frac{n1}{2}+k)\\Gamma(\\frac{n2}{2})} · (\\frac{n1}{n2})^{\\frac{n1}{2}+k}x^{\\frac{n1}{2}+k-1}(1 + \\frac{n1}{n2}x)^{-\\frac{n1+n2}{2}-k} \\\\\\ x \\gt 0, \\quad n1,n2 \\gt 0, \\quad \\delta \\ge 0\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\frac{((1+\\kappa x)\\delta x + \\gamma)e^{-\\frac{1}{2\\delta x^2}}}{(1 + \\kappa x)^{\\frac{\\gamma}{\\kappa+1}}}, \\quad x \\gt 0, \\quad \\delta \\gt 0, \\quad \\kappa \\gt 0 \\quad and \\quad \\gamma \\gt 0\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\frac{1}{2\\alpha_2} e^{-\\frac{|x - \\alpha_1|}{\\alpha_2}}, \\quad x\\in \\mathbb{R}, \\quad \\alpha_1\\in \\mathbb{R}, \\quad \\alpha_2 \\gt 0\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x;\\beta) = \\begin{cases} \\beta x^{\\beta-1}, & x\\in {[0,1]} \\\\\\ 0, & \\text{otherwise.} \\end{cases}\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x;n1,n2,\\delta,\\gamma) = e^{-\\frac{\\delta+\\gamma}{2}} \\Sigma^\\infty_{i=0}\\Sigma^\\infty_{j=0} \\frac{(\\frac{\\delta}{2})^i(\\frac{\\gamma}{2})^j}{i!j!} · \\frac{\\Gamma(\\frac{n1+n2}{2}+i+j)}{\\Gamma(\\frac{n1}{2}+i)\\Gamma(\\frac{n2}{2}+j)} · (\\frac{n1}{n2})^{\\frac{n1}{2}+i} · \\frac{x^{\\frac{n1}{2}+i-1}}{(1+\\frac{n1}{n2}x)^{\\frac{n1+n2}{2}+i+j}}, \\\\\\ x \\gt 0, \\quad n1,n2 \\gt 0, \\quad \\delta,\\gamma \\ge 0\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\frac{x}{\\alpha^2} e^{-x^2 / (2 \\alpha^2)}, \\quad x \\ge 0, \\quad \\alpha \\gt 0\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\frac{\\lambda \\kappa^{\\lambda}}{x^{\\lambda + 1}}, \\quad x \\ge \\kappa\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\begin{cases} 2x & 0 \\le x < 1, \\\\ 2(2 - x) & 1 \\le x \\le 2, \\\\ 0 & \\text{otherwise.} \\end{cases}\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\frac{\\alpha \\beta^\\alpha}{x^{\\alpha + 1}} e^{-\\beta / x}, \\quad x > 0, \\quad \\alpha \\gt 0, \\quad \\alpha \\gt 0\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\alpha \\beta x^{\\alpha - 1} e^{-(x / \\beta)^\\alpha}, \\quad x \\ge 0, \\quad \\alpha \\gt 0, \\quad \\beta \\gt 0\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x;\\lambda,\\kappa) = \\frac{\\kappa}{\\lambda} (\\frac{x}{\\lambda})^{\\kappa-1} · \\frac{1}{[1 + (\\frac{x}{\\lambda})^\\kappa]^2}, \\quad x \\gt 0, \\quad \\lambda \\gt 0, \\quad \\kappa \\gt 0\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nP(D = d) = \\lg (1 + \\frac{1}{d}), \\quad d = 1,2,3,\\ldots,9. \n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\n\\begin{cases} \\frac{2(x-a)}{(b-a)(c-a)}, & a \\le x \\le c, \\\\\\ \\frac{2(b-x)}{(b-a)(b-c)}, & c \\lt x \\le b, \\\\\\ 0, \\text{otherwise.}. \\end{cases} \n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\frac{1}{b - a}, \\quad a \\le x \\le b, \\quad a \\neq b\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\beta e^{-\\beta (x - \\alpha)} e^{-e^{-\\beta (x - \\alpha)}}, \\quad x \\in \\mathbb{R}\n$$\n',
    ...
    },
    {
      ...
      pdf: '\n$$\nf(x) = \\frac{\\lambda}{\\kappa} \\left(1 + \\frac{x}{\\kappa}\\right)^{-(\\lambda + 1)}, \\quad x \\gt 0, \\quad {\\lambda} \\gt 0, \\quad {\\kappa} \\gt 0\n$$\n',
    ...
    },
    {
      ...
      pdf: '$$\nf(x) = \\frac{e^{\\kappa \\cos(x - \\mu)}}{2\\pi I_0(\\kappa)}, \\quad 0 < x < 2\\pi\n$$\n',
    },
    {
      label: 'Generalized Pareto(δ,κ,γ)',
      position: { x: -350, y: 100 },
      chineseTranslation: '广义帕累托分布(δ, κ, γ)',
      pdf: '$$\nf(x) = \\left( \\gamma + \\frac{\\kappa}{x + \\delta} \\right)(1 + x / \\delta)^{-\\kappa} e^{-\\gamma x}, \\quad \\delta > 0;\\ \\gamma \\geq 0;\\ \\kappa \\geq -\\delta \\gamma\n$$\n',
    },
    {
      label: 'Logistic(κ,γ)\nS,V',
      position: { x: -350, y: 100 },
      chineseTranslation: '逻辑斯蒂分布(κ, γ)\nS, V',
      pdf: '$$\nf(x) = \\frac{\\lambda^\\kappa \\kappa e^{\\kappa x}}{\\left(1 + (\\lambda e^x)^\\kappa\\right)^2}, \\quad -\\infty < x < \\infty\n$$\n',
    },
    {
